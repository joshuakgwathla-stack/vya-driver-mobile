        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.empty}>
              ...
              <Text style={styles.emptyText}>Booking alerts and payout updates will appear here</Text>
            </View>
          }
        />
      )}
...
const styles = StyleSheet.create({
  ...
  header: {
    backgroundColor: COLORS.navy, paddingHorizontal: 24, paddingBottom: 20,
    paddingTop: Platform.OS === 'android' ? 48 : 20,
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
  },
  title: { fontSize: 22, fontWeight: '800', color: COLORS.white },
  unreadSub: { fontSize: 12, color: COLORS.gold, marginTop: 2, fontWeight: '600' },
